// To parse this data:
//
//   import { Convert, Consulta } from "./file";
//
//   const consulta = Convert.toConsulta(json);
//
...
const typeMap: any = {
  Consulta: o(
    [{ json: 'Registros', js: 'Registros', typ: a(r('Registro')) }],
    false
  ),
  Registro: o(
    [
      ...
      { json: 'fecha_inicio', js: 'fecha_inicio', typ: '' },
      { json: 'fecha_fin', js: 'fecha_fin', typ: '' },
      { json: 'dias_disfrutados', js: 'dias_disfrutados', typ: 0 },
      { json: 'forma_utilizacion', js: 'forma_utilizacion', typ: '' },
      { json: 'acta_de_disfrute', js: 'acta_de_disfrute', typ: '' },
    ],
    false
  ),
};*/
