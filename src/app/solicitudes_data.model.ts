...
export class Convert {
  public static toSolicitudesVacaciones(json: string): SolicitudesVacaciones {
    return cast(JSON.parse(json), r('SolicitudesVacaciones'));
  }

  public static solicitudesVacacionesToJson(
    value: SolicitudesVacaciones
  ): string {
    return JSON.stringify(uncast(value, r('SolicitudesVacaciones')), null, 2);
  }
}
